        ...
        {foreach from=$addons_products item=product}
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="panel">
                    ...
                    <a href="{$product.url|escape:'quotes':'UTF-8'}" target="_blank">
                        <img class="img-responsive" src="{$product.cover.big|escape:'quotes':'UTF-8'}">
                    </a>
                    <br/>
                    <a href="{$product.url|escape:'quotes':'UTF-8'}" class="btn btn-primary btn-lg btn-block" target="_blank">{l s='Discover' mod='ps_emailsmanager'}</a>
                </div>
            </div>
        {/foreach}
    </div>
